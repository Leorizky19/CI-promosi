...
<head>
		...
		<!-- Style CSS -->
		<link rel="stylesheet" href="<?=base_url('front-end/');?>assets/css/style.css?token=1">
		<link rel="stylesheet" href="<?=base_url('front-end/');?>assets/css/pricing.css">
		<!-- Responsive CSS -->
		<link rel="stylesheet" href="<?=base_url('front-end/');?>assets/css/responsive.css">
		
		<!-- Favicon -->
		<link rel="icon" type="image/png" href="<?=base_url('front-end/');?>assets/img/ET.png">
		<!-- Title -->
		<title>E-Treding</title>
